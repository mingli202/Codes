...
void TwoD_array(void) {
  int k[2][6] = {{1, 2, 3, 4, 5, 6}, {1, 2, 3, 4, 5, 6}};
...
void vector_shit(void) {
  ...
  std::vector<std::vector<int>> the_vector{{1, 2, 3, 4, 5}, {2, 3, 4, 5, 6}};
  ...
  std::vector<std::vector<int>> aVector{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
...
void map_shit() {
  std::map<std::string, int> myMap = {{"one", 1}, {"three", 3}};
  myMap["two"] = 2;
  std::cout << myMap["two"] << "\n";
  std::cout << myMap["one"] << "\n";
  std::cout << myMap["three"] << "\n";

  std::map<std::string, myStruct> map2 = {{"Point A", {100, 4}}};
...
int main() {
  ...
  std::map<std::string, player_stats> players{
      {"Player 1", {100, 100, {10, 20}}}, {"Player 2", {100, 100, {10, 20}}}};
