# UniqueWebpages
This repository can be cloned to your local workstation in order to resolve the `UniqueWebpages` problem.
...
- Create a branch from the main branch to start working (e.g. `homework`)
    ...
    ```
- Open the `UniqueWebpages.sln` solution in your favorite IDE
...
Past the due date, the teacher assistants will start grading your assignments. Watch for their commit in your repository, the grades will be delivered as a `Grade.txt` file in your repository.
