# BigBangIntroduction
This repository can be cloned to your local workstation in order to resolve the `BigBangIntroduction` problem.
...
- Create a branch from the main branch to start working (e.g. `homework`)
    ...
    ```
- Open the `BigBangIntroduction.sln` solution in your favorite IDE
