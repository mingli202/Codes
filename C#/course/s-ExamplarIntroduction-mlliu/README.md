# ExamplarIntroduction
This repository can be cloned to your local workstation in order to resolve the `ExamplarIntroduction` problem.
...
- Create a branch from the main branch to start working (e.g. `homework`)
    ...
    ```
- Open the `ExamplarIntroduction.sln` solution in your favorite IDE
