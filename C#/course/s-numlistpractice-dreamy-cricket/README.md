# NumListPractice
This repository can be cloned to your local workstation in order to resolve the `NumListPractice` problem.
...
- Create a branch from the main branch to start working (e.g. `homework`)
    ...
    ```
- Open the `NumListPractice.sln` solution in your favorite IDE
